...
#'
#' A dataset containing data for 50 participants from a fictional preclinical
#' AD cohort.
#'
#' @format A data frame with 50 rows and 18 variables:
#' \describe{
#'   \item{IDNUM}{Participant Identification Number}
#'   \item{COHORT}{Cohort Name (here "Example")}
#'   \item{VISIT}{Visit ID (e.g. Baseline, M6, M12, etc.)}
#'   \item{AGE}{Age in years}
#'   \item{SEX}{Participant Gender}
